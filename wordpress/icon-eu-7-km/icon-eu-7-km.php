...
add_shortcode('icon_eu_meteo', function ($atts) {
    ...
    wp_enqueue_style('icon-eu-7-km', plugins_url('assets/icon-eu.css', __FILE__), array(), '3.2.0');
    wp_enqueue_script('icon-eu-7-km', plugins_url('assets/icon-eu.js', __FILE__), array(), '3.2.0', true);
    ...
    <section class="icon-eu-widget" data-code="<?php echo esc_attr($code); ?>" data-source="https://raw.githubusercontent.com/alertesmeteo-hub/ICON-EU-7-km/data/">
      ...
      <footer class="icon-eu-footer"><span>Données DWD Open Data · ICON‑EU</span><strong>Module ICON‑EU v3.2.0</strong></footer>
    </section>
